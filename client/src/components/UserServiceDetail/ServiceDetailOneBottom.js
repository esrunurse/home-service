    ...
    <div className="flex justify-between mx-40 pt-8">
      <div className="w-[735px] px-6 pt-6 pb-8  flex flex-col justify-between border border-grey300 rounded-lg">
        ...
        <div>
          {fakeData.map((data) => {
            return (
              <div className="w-[687px] h-[105px] pt-[23px] pb-[26px] flex justify-between items-center">
      ...
      <div className="w-[349px] pt-4 px-6 border rounded-lg border-[#D8D8D8] flex flex-col gap-4">
